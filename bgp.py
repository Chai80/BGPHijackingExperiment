...
class SimpleTopo(Topo):
    ...
    def __init__(self):
        ...
        num_hosts_per_as = 2       #Don't change 2 hosts per AS
        num_ases = 5          # 5 AS 1 Rogue
        ...
        #Add links
        # In the demo code, they run through the code and add a link
        # We will add our links manually in our code, they don't need to be added in a loop

        #dd links connected to node 1
        self.addLink("R1", "R2")
        self.addLink("R1", "R3")

        # add links connected to node 2
        self.addLink("R2", "R3")
        self.addLink("R2", "R4")
        self.addLink("R2", "R5")

        # add links connected to node 3
        self.addLink("R3", "R4")
        self.addLink("R3", "R5")

        #Links starting from R4
        self.addLink("R4", "R5")


        routers.append(self.addSwitch('R6')) #Adds rogue switch R6
        ...
        #Add the link between R1 and R4
        self.addLink('R5', 'R6')
